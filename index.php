...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../ol/v5.2.0-dist/ol.css">
    ...
    <script type="text/javascript" src="../ol/v5.2.0-dist/ol.js"></script>
  ...
  <body onload="CrearMapa('blue_sea_usig');IniciarBarraLateral();CargarTematicas('');CargarNodos('');CrearMenuGestionCapas();GetRecords();ActivarListenerArchivosExternos();ActivarListenerCargarContexto();CrearLeyendaVacia();PonerIdioma('');">
    ...
    <main>
      ...
      <!-- Controles y menú de herramientas de medición -->
      ...
      <!-- Controles y menú de herramientas de dibujo -->
      ...
      <!-- Control y menú de cambio de mapa base -->
      <div class="ol-control boton_cambio_base">
         ...
         <button id="btnCerrarMapaBase" class="m-0 p-1 cerrar" onclick="CerrarMenuMapaBase();" style="display:none;"  title=""><i class="fas fa-th-large"></i></button>
      </div>
      <div id="menuMapaBase" class="row m-0 p-0 div_cambio_mapa_base" style="display:none;">
        
        <div id="baseVTuSIG_BlueBaseMap" class=" m-0 p-0 mapa_base_i mapa_base_VTusig_bluebasemap" onclick="CambioMapaBase('blue_sea_usig');" title="Vector Tiles uSIGyHD BlueBaseMap"></div>
        <div id="baseVTusig_light" class=" m-0 p-0 mapa_base_i mapa_base_VTusig_light" onclick="CambioMapaBase('vector_tiles_usig_light');" title="Vector Tiles uSIGyHD light"></div>
        <div id="baseVTusig_dark" class=" m-0 p-0 mapa_base_i mapa_base_VTusig_dark" onclick="CambioMapaBase('vector_tiles_usig_dark');" title="Vector Tiles uSIGyHD dark"></div>
        <div id="baseVTuSIG_OceanBaseMap" class=" m-0 p-0 mapa_base_i mapa_base_VTusig_oceanbasemap" onclick="CambioMapaBase('vector_tiles_usig_oceanbasemap');" title="Vector Tiles uSIGyHD OceanBaseMap"></div>
      ...
      <!-- Contenedor del menú lateral izquierdo (sidebar) -->
              ...
              <div id="espMenuBusqueda" class="row m-1 p-0">
                ...
                <div class="tab-content w-100 m-1" id="espCarga">
                  ...
                  <div class="tab-pane fade" id="espURL" role="tabpanel" aria-labelledby="tabURL">
                    <div class="input-group m-0 p-0">
                        <input name="cargar ruta" class="form-control" id="cargarURL" placeholder="Dirección url del servicio" onFocus="this.value='';VaciarListaCapas()">
                        <div class="input-group-prepend">
      ...
      <div class="container-fluid">
        <div class="row justify-content-between">
          <div class="col-3">
            <div class="row justify-content-start">
              <div class="col-12 m-0 p-0">
                ...
                <a href="http://unidadsig.cchs.csic.es/sig/" target="_blank" class="mx-2 p-0"><img src="img/usigGOs.png" class="my-1" alt="uSIGyHD" title="uSIGyHD" style="height:1.6em;"></img></a>
              </div>
            </div>
          </div>
          <div class="col-6 align-self-center">
            <div class="row justify-content-center">
              <div class="col-12 m-0 p-0 ">
                <p class="m-0 p-0 d-none d-sm-none d-md-none d-lg-block link_pie_CSIC text-center">C/Albasanz, 26-28. Madrid 28037 (España). Tlf: +34 91 602 23 00 Fax: +34 91 602 29 71 || <a href="http://usig-proyectos.cchs.csic.es/IMAGOORBIS/Doc_Legal/Aviso%20Legal.pdf" target="_blank" >Aviso legal</a> - 2018 © Consejo Superior de Investigaciones Científicas</p>
                <p class="m-0 p-0 d-none d-sm-block d-md-block d-lg-none d-xl-none link_pie_CSIC text-center"><a href="http://usig-proyectos.cchs.csic.es/IMAGOORBIS/Doc_Legal/Aviso%20Legal.pdf" target="_blank" >Aviso legal</a> - 2018 © Consejo Superior de Investigaciones Científicas</p>
                <p class="m-0 p-0 d-sm-none d-md-none d-lg-none d-xl-none link_pie_CSIC text-center"><a href="http://usig-proyectos.cchs.csic.es/IMAGOORBIS/Doc_Legal/Aviso%20Legal.pdf" target="_blank" >Aviso legal</a> - 2018 © CSIC</p>
              </div>
            </div>
          </div>
          <div class="col-3">
            <div class="row justify-content-end">
              <div class="col-auto m-0 p-0">
                ...
                <button id="btnGithub" class="btn boton_transparente ml-auto m-0 mx-2 my-1 p-0" title="" onclick="window.open('https://github.com/alejandrobarriuso/visualizador_IO')">
